...
public interface LAListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LAParser#parentesis_expressao}.
	 * @param ctx the parse tree
	 */
	void enterParentesis_expressao(LAParser.Parentesis_expressaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link LAParser#parentesis_expressao}.
	 * @param ctx the parse tree
	 */
	void exitParentesis_expressao(LAParser.Parentesis_expressaoContext ctx);
	/**
